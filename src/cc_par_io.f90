...
SUBROUTINE read_parameters
  ...
  NAMELIST /numerical_parameters/ &
      ...
      init_amp_bx,init_amp_by,init_amp_bz, init_amp_vx, init_amp_vy, init_amp_vz,init_kolm,phdf,hyp, &
  ...
  NAMELIST /flags/ &
      ...
      perf_test_lin,perf_test_nl,perf_test_rhs,rhs_lin_version,rhs_nl_version,dealias_type,&
