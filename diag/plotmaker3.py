...
lpaths = ["/scratch/08929/echansen/dna2mhdrun445","/scratch/08929/echansen/dna2mhdrun446"]

fname = {lpaths[0]:lpaths[0]+"/DNAHD.out11731155",lpaths[1]:lpaths[1]+"/DNAHD.out11731168"}
