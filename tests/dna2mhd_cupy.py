...
class RHS:
    ...
    def convolutions(self,binput,vinput):
        ...
        backffts = cp.stack((binput[0,:,:,:],binput[1,:,:,:],binput[2,:,:,:],
                            ...
                            1j*self.kzgrid[None,None,:]*binput[0,:,:,:]-1j*self.kxgrid[:,None,None]*binput[2,:,:,:],
                            1j*self.kxgrid[:,None,None]*binput[1,:,:,:]-1j*self.kygrid[None,:,None]*binput[0,:,:,:],
                            1j*self.kygrid[None,:,None]*vinput[2,:,:,:]-1j*self.kzgrid[None,None,:]*vinput[1,:,:,:],
        ...
        forwardffts = cp.stack(((real_backffts[:,:,:,4]-self.hallparam*real_backffts[:,:,:,7])*real_backffts[:,:,:,2] \
                                - (real_backffts[:,:,:,5]-self.hallparam*real_backffts[:,:,:,8])*real_backffts[:,:,:,1] ,
                                (real_backffts[:,:,:,5]-self.hallparam*real_backffts[:,:,:,8])*real_backffts[:,:,:,0] \
                                - (real_backffts[:,:,:,3]-self.hallparam*real_backffts[:,:,:,6])*real_backffts[:,:,:,2],
                                (real_backffts[:,:,:,3]-self.hallparam*real_backffts[:,:,:,6])*real_backffts[:,:,:,1] \
                                - (real_backffts[:,:,:,4]-self.hallparam*real_backffts[:,:,:,7])*real_backffts[:,:,:,0],
                                real_backffts[:,:,:,4]*real_backffts[:,:,:,11]-real_backffts[:,:,:,5]*real_backffts[:,:,:,10] \
                                - (real_backffts[:,:,:,1]*real_backffts[:,:,:,8] - real_backffts[:,:,:,2]*real_backffts[:,:,:,7]),
                                real_backffts[:,:,:,5]*real_backffts[:,:,:,9]-real_backffts[:,:,:,3]*real_backffts[:,:,:,11] \
                                - (real_backffts[:,:,:,2]*real_backffts[:,:,:,6] - real_backffts[:,:,:,0]*real_backffts[:,:,:,8]),
                                real_backffts[:,:,:,3]*real_backffts[:,:,:,10]-real_backffts[:,:,:,4]*real_backffts[:,:,:,9] \
        ...
        bout[0,:,:,:] = 1j * self.kygrid[None,:,None] * complex_forwardffts[:,:,:,2] \
            - 1j * self.kzgrid[None,None,:] * complex_forwardffts[:,:,:,1]
        bout[1,:,:,:] = 1j * self.kzgrid[None,None,:] * complex_forwardffts[:,:,:,0] \
            - 1j * self.kxgrid[:,None,None] * complex_forwardffts[:,:,:,2]
        bout[2,:,:,:] = 1j * self.kxgrid[:,None,None] * complex_forwardffts[:,:,:,1] \
            - 1j * self.kygrid[None,:,None] * complex_forwardffts[:,:,:,0]

        vout[0,:,:,:] = complex_forwardffts[:,:,:,3]
        vout[1,:,:,:] = complex_forwardffts[:,:,:,4]
        vout[2,:,:,:] = complex_forwardffts[:,:,:,5]

        del complex_forwardffts

        bout = bout * self.padding[None,:,:,:]
        vout = vout * self.padding[None,:,:,:]
