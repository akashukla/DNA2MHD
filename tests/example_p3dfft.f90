program exp3d
  ...
  ! mpif90 -g -O2 -r8  -L$P3DFFT_INTEL2/lib -L$FFTW_ROOT/lib -I$P3DFFT_INTEL2/include -I$FFTW_ROOT/lib -o exp3d example_p3dfft.f90 -lp3dfft -lfftw3_mpi -lfftw3

  integer(4) :: nx=512
  integer(4) :: nx0_big,ny0_big,nz0_big
  integer(4) :: ierr
  ...
  CALL p3dfft_setup([2,np/2],nx0_big,ny0_big,nz0_big,MPI_COMM_WORLD,overwrite=.true.)
  ...
  DO repeat = 1,500
     ...
     if (mod(repeat,30).eq.0.and.mype.eq.0) print *, "Iteration ",repeat
