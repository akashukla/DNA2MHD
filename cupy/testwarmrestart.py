...
#    eta *= 1/((N/256 * np.sqrt(2)/3)**(4/3))
    ...
    solver1 = DNA2MHD(nkx0,nky0,nkz0,kxmin,kymin,kzmin,nu,eta,
                     ...
                     forcetype="threewave",hallparam=1.0,
                      solveprec=16,maxwallclock=86200,triplet=triplet,records=10,bittype=64,exactnueta=False)
    ...
    #                  linear=False,
    #                  initcond="threewave",energystart=0.01,init_kolm=0,hmhdwave=[1,0,0,0],
    #                  forcetype="hallwave",forceamp=0.0,nforce=4,forcewave=[1,0,0,0],hallparam=1.0,
    #                    solveprec=16,maxwallclock=86200,triplet=triplet,records=5,bittype=64,exactnueta=False)

    # solver2a.gauss2split()
    ...
    #                  solveprec=16,maxwallclock=86200,triplet=triplet,records=5,bittype=64,exactnueta=True)

    # solver2b.gauss2split()
