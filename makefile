...
cc_get_rhs_nl_mpi.o:	cc_par_mod.o #cc_field_solver.o
...
cc_time_advance.o:	cc_par_mod.o cc_get_rhs_lin.o cc_get_rhs_nl_mpi.o ee_diagnostics.o 

cc_main.o:			cc_par_mod.o cc_comm.o cc_init.o \
				cc_par_io.o cc_time_advance.o  \
				cc_get_rhs_nl_mpi.o ee_diagnostics.o  #cc_hk.o cc_flr.o  ee_diagnostics.o `ee_performance.o  ee_triple_transfers.o

ee_diagnostics.o:	cc_par_mod.o cc_get_rhs_lin.o cc_get_rhs_nl_mpi.o \
