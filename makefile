...
#  cc_calc_dt.o:	cc_par_mod.o ee_eigen_iterative.o  cc_get_rhs_nl_c2c.o ee_eigen_direct.o
#else
#cc_calc_dt.o:	cc_par_mod.o  cc_get_rhs_nl_c2c.o #ee_eigen_direct.o
#endif
...
cc_get_rhs_nl_c2c.o:	cc_par_mod.o #cc_field_solver.o
...
cc_time_advance.o:	cc_par_mod.o cc_get_rhs_lin.o cc_get_rhs_nl_c2c.o ee_diagnostics.o 

cc_main.o:			cc_par_mod.o cc_comm.o cc_init.o \
				cc_par_io.o cc_time_advance.o  \
				cc_get_rhs_nl_c2c.o ee_diagnostics.o  #cc_hk.o cc_flr.o  ee_diagnostics.o `ee_performance.o  ee_triple_transfers.o

ee_diagnostics.o:	cc_par_mod.o cc_get_rhs_lin.o cc_get_rhs_nl_c2c.o \
...
#ee_performance.o:	cc_par_mod.o cc_get_rhs_lin.o cc_get_rhs_nl_c2c.o \
				cc_time_advance.o #cc_field_solver.o 
#ee_triple_transfers.o:	cc_par_mod.o cc_get_rhs_nl_c2c.o #cc_field_solver.o 			
#ee_Gyro_LES.o:	cc_field_solver.o cc_par_mod.o cc_get_rhs_nl_c2c.o \
