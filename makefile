...
OBJLIST = $(OBJDIR)/cc_comm.o \
                 ...
                 $(OBJDIR)/cc_get_rhs_nl_gpumany.o \
                 $(OBJDIR)/cc_init.o \
...
#  cc_calc_dt.o:	cc_par_mod.o ee_eigen_iterative.o  cc_get_rhs_nl_gpumany.o ee_eigen_direct.o
#else
#cc_calc_dt.o:	cc_par_mod.o  cc_get_rhs_nl_gpumany.o #ee_eigen_direct.o
#endif
...
$(OBJDIR)/cc_get_rhs_nl_gpumany.o:	$(OBJDIR)/cc_par_mod.o #cc_field_solver.o
...
$(OBJDIR)/cc_initial_condition.o:	$(OBJDIR)/cc_par_mod.o $(OBJDIR)/cc_par_io.o $(OBJDIR)/ee_mtrandom.o $(OBJDIR)/ee_diagnostics.o $(OBJDIR)/cc_get_rhs_lin.o
$(OBJDIR)/cc_par_io.o:	$(OBJDIR)/cc_par_mod.o #cc_gaussquadrature.o
#cc_gaussquadrature.o:	cc_par_mod.o
$(OBJDIR)/cc_time_advance.o:	$(OBJDIR)/cc_par_mod.o $(OBJDIR)/cc_get_rhs_lin.o $(OBJDIR)/cc_get_rhs_nl_gpumany.o $(OBJDIR)/ee_diagnostics.o 

$(OBJDIR)/cc_main.o:			$(OBJDIR)/cc_par_mod.o $(OBJDIR)/cc_comm.o $(OBJDIR)/cc_init.o \
				$(OBJDIR)/cc_par_io.o $(OBJDIR)/cc_time_advance.o  \
				$(OBJDIR)/cc_get_rhs_nl_gpumany.o $(OBJDIR)/ee_diagnostics.o  #cc_hk.o cc_flr.o  ee_diagnostics.o `ee_performance.o  ee_triple_transfers.o

$(OBJDIR)/ee_diagnostics.o:	$(OBJDIR)/cc_par_mod.o $(OBJDIR)/cc_get_rhs_lin.o $(OBJDIR)/cc_get_rhs_nl_gpumany.o \
...
#ee_performance.o:	cc_par_mod.o cc_get_rhs_lin.o cc_get_rhs_nl_gpumany.o \
				cc_time_advance.o #cc_field_solver.o 
#ee_triple_transfers.o:	cc_par_mod.o cc_get_rhs_nl_gpumany.o #cc_field_solver.o 			
#ee_Gyro_LES.o:	cc_field_solver.o cc_par_mod.o cc_get_rhs_nl_gpumany.o \
